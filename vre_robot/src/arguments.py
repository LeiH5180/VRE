...
def parse_args():
    ...
    parser.add_argument('--if_base', default='dtk', type=str)
    parser.add_argument("--algorithm", default="dtk", type=str)
    ...
    parser.add_argument('--auto_para', default=True, type=str)
    parser.add_argument('--auto_Q', default=True, type=str)
    ...
    parser.add_argument("--log_dir", default="25w_logs_robot_dtk", type=str)
